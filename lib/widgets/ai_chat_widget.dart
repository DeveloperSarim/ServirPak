...
class _AIChatWidgetState extends State<AIChatWidget> {
  ...
  Future<void> _initializeAI() async {
    try {
      ...
      // Add welcome message
      _addMessage(
        'Welcome! I\'m your AI legal assistant powered by Gemini. I can help you with questions about Pakistani law and the Constitution. How can I assist you today?',
        isUser: false,
      );
    } catch (e) {
      setState(() {
